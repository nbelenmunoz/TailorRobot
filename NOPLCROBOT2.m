...
M = [
    315.000,  -60.000, 470.000, -180.000, 0.000, 0.000, 80, 0,  1; % P1S
    315.000,  -60.000, 410.000, -180.000, 0.000, 0.000, 10, 100, 2; % P1
    315.000,   60.000, 410.000, -180.000, 0.000, 0.000, 10, 100, 0; % P2
    315.000,   60.000, 470.000, -180.000, 0.000, 0.000, 10, 100, 0;
    315.000,   60.000, 470.000, -180.000, 0.000, 0.000, 10, 0,  2; % P2S
];
...
if estrusore==1
    ...
    data=EXTRSTART(t(toolvec(2)),temperatura,tempospurgo,gspurgo);
end
...
if robot1>0 %Se il robot esiste
    ...
    for k=1:nbuff
        str="P-fatto";
        %data=TEACH(t(1),PPstr(k,1),num2str(vel(k,1)),str); %descomente esto
        write(t(1),PPstr(k,1));
        pause(0.5);
